...
const EXPECTED_SHA1 = String(process.env.ECHO_NATIVE_LOADER_SHA1 || '6c82b842bb325994eca8ac243bb22d69b8a6baef').toLowerCase()
const EXPECTED_SIZE = Number(process.env.ECHO_NATIVE_LOADER_SIZE || 1_834_113)
