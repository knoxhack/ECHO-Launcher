...
export const officialModpacks: OfficialModpack[] = [
  ...
  },
  {
    ...
    status: 'preview',
    phase: 'Blocked Preview',
    version: 'Catalog gated',
    minecraft: '26.1.2',
    channel: 'alpha',
    summary: 'Floating-island relay recovery built for the ECHO Native Loader path.',
    detail: 'Phase-gated preview for the native Sky Relay package. The card stays view-only until manual gameplay evidence and the release pipeline pass.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
  {
    ...
    detail: 'Phase-gated preview for the NeoForge Sky Relay package. The card stays view-only until manual gameplay evidence and public-alpha readiness pass.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
  {
    ...
    detail: 'Phase-gated preview for the standalone Sky Relay package. It will unlock after runtime evidence, save reload proof, and promotion dry-run pass.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
]
