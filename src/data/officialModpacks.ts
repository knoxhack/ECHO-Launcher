...
export const officialModpacks: OfficialModpack[] = [
  ...
  },
  {
    ...
    detail: 'Phase-gated preview for the native Sky Relay package. The card stays view-only until signed artifacts, manifests, and install evidence are published.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
  {
    ...
    detail: 'Phase-gated preview for the NeoForge Sky Relay package. The card stays view-only until strict release assets and launcher repair evidence exist.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
  {
    ...
    detail: 'Phase-gated preview for the standalone Sky Relay package. It will unlock after runtime harness evidence and rollback checks are attached.',
    image: orbitalCardImage,
    moduleCount: 5,
  },
]
