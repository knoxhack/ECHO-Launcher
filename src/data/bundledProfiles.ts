...
export const bundledProfiles: LauncherProfile[] = [
  ...
  },
  {
    ...
    channelLabel: 'Ashfall Standalone',
    version: '0.1.0',
    minecraft: 'Runtime',
    neoforge: 'N/A',
    ramGb: 7,
  ...
  },
  {
    ...
    runtimeMode: 'native-loader-minecraft',
    channel: 'alpha',
    channelLabel: 'Galactic Survey Native',
    version: '0.1.0',
    minecraft: '26.1.2',
    neoforge: 'N/A',
    ramGb: 7,
  ...
  },
  {
    ...
    runtimeMode: 'neoforge-minecraft',
    channel: 'alpha',
    channelLabel: 'Galactic Survey NeoForge',
    version: '0.1.0',
    minecraft: '26.1.2',
    neoforge: '26.1.2',
    ramGb: 7,
  ...
  },
  {
    ...
    runtimeMode: 'native-runtime',
    channel: 'alpha',
    channelLabel: 'Galactic Survey Standalone',
    version: '0.1.0',
    minecraft: 'Standalone',
    neoforge: 'N/A',
    ramGb: 7,
  ...
  },
  {
    ...
    runtimeMode: 'neoforge-minecraft',
    channel: 'alpha',
    channelLabel: 'Openlands NeoForge',
    version: '0.1.0',
    minecraft: '26.1.2',
    neoforge: '26.1.2',
    ramGb: 7,
  ...
  },
  {
    ...
    runtimeMode: 'native-runtime',
    channel: 'experimental',
    channelLabel: 'Openlands Standalone',
    version: '0.1.0',
    minecraft: 'Standalone',
    neoforge: 'N/A',
    ramGb: 7,
